""" Final version of the program All the feedbacks from the end user has
been included (Format, Adding round numbers)

"""
import random


# Yes no checker. It asks for an answer of either yes or no. When something
# else it entered, it outputs an error
...
def instructions():
    ...
    print("This is a Maori quiz game\nThere are 2 sets of quiz.\nQuiz One "
          "being Maori Numbers from 1 to 10"
          "and Quiz Two being Maori Day of the week\nYou can select the "
          "questions by typing"
          " o or one for set 1 and t or two for set 2\n"
          "You will gain 1 point from getting question correct and lose 1 "
...
def question(question_text):
    while True:
        ...
        # If they say "t", Program displays question set 2 and continues
            ...
            answer = "two"
            return answer
        # If they say "x", it displays "Thank you for using our program,
        # " and exits
        elif answer == "x":
            return answer
...
# Generates Maori numbers from 1 to 10 randomly with no repetitive question.
# Runs until all the words has run out from the list
...
def generate_question_1():
    ...
    # 1nd list
    maori_numbers = [["tahi", "1"], ["rua", "2"], ["toru", "3"], ["wha", "4"],
                     ["rima", "5"], ["ono", "6"], ["whitu", "7"],
...
# 2nd quiz function where it generates Days of the week in Maori. It also
# runs until all the words has run out/
...
print()
played_before = yes_no("Have you play this game before? Please enter 'yes or "
                       "'no': ")
# Displays instruction when answer equals no
if played_before == "No":
    instructions()
    start = yes_no("Are you ready to start? (type 'yes' to continue 'no' to "
                   "exit): ")
...
# The user can choose what to play by typing "o" or "t" or they can press x
# to exit
while start == "Yes":
